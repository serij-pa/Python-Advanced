...
from models import init_db, get_all_books, DATA, add_new_book, search, create_table_description_book, DESCRIPTION_BOOK, get_all_descriptions, description
...
def all_books() -> str:
    ...
    return render_template('index.html', books=get_all_books(), descriptions=descriptions)
...
def get_description(id_book: int):
    return render_template('descript.html', book=description(id_book))
