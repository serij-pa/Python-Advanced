...
emails_list = ['sergey.palagin82@gmail.com', 's.n.palagin@yandex.ru']

@celery.task
def process_image(image_filename):
    new_img_filename = blur_image(image_filename)
    return f'{new_img_filename}'


@celery.on_after_configure.connect
def setup_periodic_tasks(sender, **kwargs):
    sender.add_periodic_task(
        crontab(hour='15', minute='00', day_of_week='wed'),
        sending_mails.s(),
