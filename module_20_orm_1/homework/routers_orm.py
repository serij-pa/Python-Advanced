...
from models_orm import Base, engine, session, Book, Student, Author, ReceivingBook
...
def get_students():
    ...
    #return render_template('list_students_orm.html', students=list_students)
...
def get_receiving_books():
    ...
    #return render_template('receiving_books.html', list_books=list_books)
